...
key = "c36bdb3b-a0bf-4cad-936c-cd7e7bc3c67a"  ## Replace with your API key
...
def geocoding(location, key):
    ...
    if json_status == 200 and len(json_data["hits"]) !=0:
        ...
        print("Geocodigo API URL " + new_loc + " (Location Type: " + value + ")\n" + url)
    else:
        lat = "null"
        lng = "null"
        new_loc = location
...
while True:
    ...
    vehicle = input("Ingrese un vehiculo mencionado en la parte superior: ")
    if vehicle == "quit" or vehicle == "q":
        ...
        vehicle = "car"
        print("Vehiculo ingresado no valido, ingrese nuevamente el vehiculo.")
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        print("Estatus de API de ruta: " + str(paths_status) + "\nURL de API de ruta:\n" + paths_url)
        print("=================================================")
        print("De " + orig[3] + " a " + dest[3])
        print("=================================================")
        if paths_status == 200:
